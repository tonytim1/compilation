...
public class IRcommand_Binop_NEQ_Integers extends IRcommand {
    public TEMP t1;
    public TEMP t2;
    public TEMP dst;

    public IRcommand_Binop_NEQ_Integers(TEMP dst, TEMP t1, TEMP t2) {
        this.dst = dst;
        this.t1 = t1;
        this.t2 = t2;
    }
    ...
    public void MIPSme() {
        ...
        /******************************************/
        /* [2] if (t1==t2) goto label_AssignZero;  */
        /*     if (t1!=t2) goto label_AssignOne; */
        /******************************************/
        MIPSGenerator.getInstance().beq(t1.toString(), t2.toString(), label_AssignZero);
        MIPSGenerator.getInstance().bne(t1.toString(), t2.toString(), label_AssignOne);
