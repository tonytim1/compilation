...
public class IRcommand_Binop_Sub_Integers extends IRcommand {
    ...
    public void MIPSme() {
        ...
        MIPSGenerator.getInstance().sub(dst.toString(), t1.toString(), t2.toString());

        // if the add product greater than max assign max to dst
        ...
        // if the add product less than min assign min to dst
